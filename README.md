...
| Backend | Node.js · Express · Flask · TensorFlow |
| Database | MySQL · MongoDB |
| DevOps | Git · GitHub · Windows |
| Learning | Traffic optimization using Deep Reinforcement Learning |
...
|------|-------------|-------|--------|
| Traffic Optimization using DRL | Training DRL to optimize traffic light systems | Python, SUMO, DRL | 🚧 WIP |
